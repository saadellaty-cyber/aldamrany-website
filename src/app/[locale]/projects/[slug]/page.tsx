          ...
          <div className="container-page grid gap-12 lg:grid-cols-12 lg:gap-16">
                  ...
                  {facts.map((fact) => (
                    <Reveal key={fact.label}>
                      <div className="flex flex-wrap items-baseline justify-between gap-4 border-b border-line py-4">
                        <dt className="eyebrow heading-yellow">{fact.label}</dt>
            ...
            <div className="lg:col-span-8">
              {project.description.length > 0 ? (
                <>
                  <Reveal>
                    <h2 className="eyebrow heading-yellow">{t('projects.overview')}</h2>
                  </Reveal>
                  <Reveal delay={0.08}>
              ...
              {project.scope.length > 0 ? (
                <div className="mt-14">
                  <Reveal>
                    <h2 className="eyebrow heading-yellow">{t('projects.scope')}</h2>
                  </Reveal>
                  <Reveal delay={0.08}>
