...
export function AdminSidebar({
  ...
  const groups: NavGroup[] = [
    ...
    },
    {
      title: t('Content'),
      items: [
        { href: '/admin/content/news', label: t('News'), icon: Newspaper },
        { href: '/admin/content/partners', label: t('Partners'), icon: Handshake },
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/admin/subscribers', label: t('Newsletter'), icon: MailCheck },
